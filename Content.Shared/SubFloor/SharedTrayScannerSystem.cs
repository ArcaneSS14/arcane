...
using Robust.Shared.Player; // Arcane-Edit
...
public abstract class SharedTrayScannerSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<TrayScannerUserComponent, PlayerAttachedEvent>(OnPlayerAttached); // Arcane-Edit
    }

    private void OnPlayerAttached(Entity<TrayScannerUserComponent> ent, ref PlayerAttachedEvent args) // Arcane-Edit
    {
