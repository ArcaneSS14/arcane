...
public sealed partial class ChangelogTab : Control, ILinkClickHandler // Arcane-Edit: ILinkClickHandler
{
    [Dependency] private readonly ChangelogManager _changelog = default!;
    [Dependency] private readonly IResourceCache _resourceCache = default!;
    [Dependency] private IUriOpener _uriOpener = default!; // Arcane
    ...
    public void PopulateChangelog(ChangelogManager.Changelog changelog)
    {
        ...
        foreach (var dayEntries in byDay)
        {
            ...
            var groupedEntries = dayEntries
                .GroupBy(c => (c.Author, c.PullRequestNumber, c.PullRequestUrl, Read: c.Id <= _changelog.LastReadId)) // Arcane-Edit
            ...
            {
                var (author, pullRequestNumber, pullRequestUrl, read) = groupedEntry.Key; // Arcane-Edit
                ...
                var authorHeader = GetAuthorHeader(author, pullRequestNumber, pullRequestUrl); // Arcane
