    ...
    private static readonly Dictionary<string, int> PatronTierPriority = new()
        {
            ...
            [SponsorRoleBenefits.All[DiscordRole.SponsorTier2].TierName] =
                SponsorRoleBenefits.All[DiscordRole.SponsorTier2].CreditsPriority,
            [SponsorRoleBenefits.All[DiscordRole.SponsorTier1].TierName] =
                SponsorRoleBenefits.All[DiscordRole.SponsorTier1].CreditsPriority,
            // arcane sponsor end
            ["Central Command"] = 1,
            ["Captain"] = 2,
            ["Station AI"] = 3,
