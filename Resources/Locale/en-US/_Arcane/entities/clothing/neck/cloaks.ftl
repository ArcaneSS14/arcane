...
ent-ClothingCloakHOSBlack = HOS' black cloak
    .desc = Brutal and gloomy.
ent-ClothingCloakHOSRed = HOS' red cloak
    .desc = Brutal and gloomy.
ent-ClothingCloakQMBlack = QM's black cloak
    .desc = Black feathers! You are definately boss here.
ent-ClothingCloakQMWhite = QM's white cloak
    .desc = Classic.
