...
alert-level-gate-authorized-initiated-announcement = Red alert unlock initiated by {$name}.
alert-level-gate-authorized-announcement = Red alert has been unlocked by {$name}.
