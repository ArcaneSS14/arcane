...
ent-CommandmentCircuitBoard = плата законов (Корпорат)
    .desc = Электронная плата, хранящая набор законов ИИ 'Корпорат'.
...
ent-ArtPlanetSupportCircuitBoard = плата законов (техподдержка ArtPlanet)
    .desc = Электронная плата, хранящая набор законов ИИ 'Техническая поддержка ArtPlanet'.
    .suffix = Адмем
