...
ghost-role-information-inteq-SIZO-rules = Вы НЕ ИМЕЕТЕ ПРАВА покидать пределы Лаваленда без разрешения администрации, или достойной причины(Без боевых действий). Вы МОЖЕТЕ конфликтовать с шахтёрами в разумную меру. Передача любого снаряжения и вещей с Сизо-73 - ЗАПРЕЩЕНА. Нарушение правил влечёт перманентную блокировку доступа к ролям Интек.
