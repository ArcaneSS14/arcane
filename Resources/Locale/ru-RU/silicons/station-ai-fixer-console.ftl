...
station-ai-fixer-console-repair-finished = Ремонт завершён. Попытка перезагрузки ИИ...
...
station-ai-fixer-console-window-station-ai-repair = Запустить иструмент ремонта
...
station-ai-fixer-console-window-flavor-left = Заблокируйте эту консоль пока она не используется
