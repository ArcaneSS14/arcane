...
abductors-ghost-role-rules =
    ...
    после чего возвращать их обратно. Вам запрещено уничтожать станцию, намеренно убивать людей или воровать станционное имущество, если оно [bold]напрямую[/bold] не помогает задержать клиентов, отремонтировать ваше оборудование/шаттл или вылечить тело.
...
abductor-role-greeting =
    Вы — профессиональный боевой учёный высокотехнологичной расы. Ваша задача — похищать людей, проводить над ними эксперименты, и возвращать живыми ради чистоты эксперимента. Вам невыгодно уничтожать станцию, убивать, помогать экипажу или воровать станционное имущество, если оно [bold]напрямую[/bold] не помогает задержать клиентов, отремонтировать ваше оборудование/шаттл или вылечить тело.
