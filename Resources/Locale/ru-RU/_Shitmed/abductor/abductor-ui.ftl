...
abductors-ghost-role-rules =
    ...
    после чего возвращать их обратно. Вам запрещено уничтожать станцию или намеренно убивать людей и воровать станционное имущество, которое [bold]напрямую[/bold] не поможет задержать клиентов, либо отремонтировать ваше оборудование/шаттл, вылечить тело.
...
abductor-role-greeting =
    Вы — профессиональный боевой учёный высокотехнологичной расы. Ваша задача — похищать людей, проводить над ними эксперименты, и возвращать живыми ради чистоты эксперимента. Вам невыгодно уничтожать станцию, убивать или помогать экипажу и воровать станционное имущество, которое [bold]напрямую[/bold] не поможет задержать клиентов, либо отремонтировать ваше оборудование/шаттл, вылечить тело.
