...
marking-HumanoidXenoTailChris = Хвост кризалис
marking-HumanoidXenoTailCougar = Хвост пумы
marking-HumanoidXenoTailCrocodile = Хвост крокодила
marking-HumanoidXenoTailRazor = Хвост разорителя
...
marking-HumanoidXenoHeadCris = Голова кризалис
marking-HumanoidXenoHeadCougar = Голова кризалис
marking-HumanoidXenoHeadCrocodile = Голова крокодила
marking-HumanoidXenoHeadProwler = Голова бродяги
marking-HumanoidXenoHeadRazor = Голова разорителя
...
marking-HumanoidXenoTracheasChris = Трахеи кризалис
...
marking-HumanoidXenoLegsChris = Когти кризалис
marking-HumanoidXenoLegsCougar = Ноги пумы
marking-HumanoidXenoLegsRazor = Стопы разорителя
...
marking-HumanoidXenoArmsChris = Руки кризалис
