        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    role_id = table.Column<ulong>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.Sql("""
                INSERT OR IGNORE INTO rmc_discord_account_roles (discord_id, role_id)
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                ...
                SET tier_id = (
                    ...
                    WHERE linked.player_id = rmc_patrons.player_id
